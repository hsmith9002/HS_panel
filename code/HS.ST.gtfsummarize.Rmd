...
## load datasets
load(file = paste("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/", "quantitation/", "HS.gtfdataframes.RData", sep = ""))
...
write.csv(tpgsummary, file = "/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/tables/HS.transcrptpergeneSummary.csv", row.names = T, quote = F)
...
write.csv(dfFinal, file = "/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/tables/Brain/HS.transcriptContentSummary.csv", row.names = F, quote = T)
...
png("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/graphics/HS.gtfTranscriptSummary.png", height = 6, width = 8, res = 480, units = "in")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
## load gtf.tmap data
load(file = paste("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/", "quantitation/", "HS.gtf.tmap.merge.RData", sep = ""))
...
write.csv(cc.pretty, file = "/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/tables/HS.classcodeSummary.csv", row.names = F, quote = T)

## Generate plot summarizing all class codes
png("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/graphics/HS.gtfClassCodeSummary.png", height = 6, width = 8, res = 480, units = "in")
...
png("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/graphics/HS.gtfClassCodeCollapsedSummary.png", height = 6, width = 8, res = 480, units = "in")
...
png("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/graphics/HS.gtfClassCodePercentSummary.png", height = 6, width = 8, res = 480, units = "in")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
## load gtf.tmap data
load(file = paste("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/", "quantitation/", "HS.brainregiongtfcomparison.RData", sep = ""))
...
## Generate plot summarizing class codes with collapsed category
png("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/graphics/HS.brainregiongtfcompare.png", height = 6, width = 8, res = 480, units = "in")
...
png("/Volumes/smiharry/Saba_Lab/RNA-Seq/HS/Brain/graphics/HS.brainregeiongtfcompareCollapsed.png", height = 6, width = 8, res = 480, units = "in")
